...
# Neural recording data root — set via environment variable MATROOT or pass matroot explicitly to functions.
# Raw .mat files are not distributed with this repo; see README for data access.
import os
